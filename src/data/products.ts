...
export const products: Product[] = [
  ...
  {
    id: '2',
    name: 'Schoudertas met koehuid',
    description: 'Stijlvolle schoudertas met een zachte buitenkant',
    fullDescription: 'Stijlvolle schoudertas. Perfect voor dagelijks gebruik.',
    material: 'koeienleer',
    type: 'schoudertas',
    size: 'middel',
    colors: ['bruin', 'wit'],
  ...
  {
    id: '4',
    name: 'Schoudertas zwart',
    description: 'Compacte schoudertas, perfect voor dagelijks gebruik.',
  ...
  {
    id: '5',
    name: 'Schoudertas geel',
    description: 'Professionele gele schoudertas, voor een beetje kleur in het leven.',
  ...
  {
    id: '6',
    name: 'Schoudertas donkergroen',
    description: 'Ruime tas voor al je spullen tijdens een kort uitje.',
    fullDescription: 'Ruime tas voor al je spullen tijdens een kort uitje. Deze tas biedt volop ruimte voor kleding, schoenen en al je benodigdheden voor een weekendje weg. Het klassieke design maakt hem geschikt voor elke gelegenheid.',
    material: 'koeienleer',
    type: 'schoudertas',
    size: 'middel',
    colors: ['groen'],
  ...
  {
    id: '7',
    name: 'Schoudertas groen',
    description: 'Stijlvolle en compacte schoudertas, ideaal voor beide werk en festivals.',
  ...
  },
  {
    id: '8',
    name: 'Schoudertas zwart',
    description: 'Elegante tas met een stevige vormgeving, perfect voor alle soorten gelegenheden.',
    fullDescription: 'Deze tas zorgt voor een elegante alledaagse look.',
    material: 'koeienleer',
    type: 'schoudertas',
    size: 'middel',
    colors: ['zwart', 'wit'],
